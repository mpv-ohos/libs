...
#define __GMP_CC "/data/ohos/ohos_sdk/linux/native/llvm/bin/clang --target=aarch64-linux-ohos"
#define __GMP_CFLAGS "-fPIC -D__MUSL__=1 -I/data/ohos/tpc_c_cplusplus/lycium/usr/libgpg-error/arm64-v8a/include/"
